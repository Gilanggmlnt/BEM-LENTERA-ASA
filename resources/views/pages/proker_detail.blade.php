                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-16 h-16 rounded-full overflow-hidden border-2 border-primary/20 flex-shrink-0">
                                @if($ketuplak && $ketuplak->photo_path && file_exists(public_path('images/' . $ketuplak->photo_path)))
                                    <img src="{{ asset('images/' . $ketuplak->photo_path) }}" alt="{{ $proker->nama_ketuplak }}" class="w-full h-full object-cover">
                                @else
